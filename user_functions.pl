...
consult_kb_change_object_related(Object1,Relation,Object2):-
	open_kb(KB),
	change_object_related(Object1,Relation,Object2,KB,NewKB),
	save_kb(NewKB),
	assign_func_value(empty).
...
location_of_an_object(O,L):-
	open_kb(KB),
	object_relation_value(O,in,KB,L),
...
:- consult('$GOLEM_IIMAS_HOME/agents/SitLog/apps/robocup2014/t2_gpsr/action_reasoner.pl').

:- consult('$GOLEM_IIMAS_HOME/agents/SitLog/apps/robocup2014/t2_gpsr/parser.pl').
...
%%	there_is_property(is_in,Properties),
	object_property_value(ObjectID,is_in,KB,Location),
